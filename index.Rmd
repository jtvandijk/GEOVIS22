...
#### Extra tasks {-}
In case you are fast, potentially because you have done some work in QGIS before, you can go ahead and try:

- Loading one of the other surname datasets in the same fashion.
- Change the colours of the different map layers to make the map look nicer.
