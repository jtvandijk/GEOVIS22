...
## Tasks {#task-s4}
Now we have been through all the steps from data loading, to making a quick visualisation and executing a full Kernel Density Estimation, you can now try to repeat all the elements that we have covered with the surname datasets of *Smith* and *Novak* in order to create a surname density maps for these two spatially heterogeneous surnames.
